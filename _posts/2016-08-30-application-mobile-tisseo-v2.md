...
* de nombreuses améliorations estétiques et de performance
...
C'est peut-être la nouveauté la plus visible, le fond de plan a été totalement renouvellé.
...
* un cache hors ligne a été implémenté pour économiser la bande passante de l'utilisateur. La taille de ce cache est de 50 mo par défaut mais peut-être modifié dans les paramètres. Le cache est très intelligent et s'adaptera aux zones visités les plus fréquement par l'utilisateur.
...
<a href="/public/images/appli-tisseo-v2/nouveau-menu.png" class="click">(Cliquez pour aggrandir)</a>
</div>
<div class="thumbnail">
...
<a href="/public/images/appli-tisseo-v2/plan-des-lignes.png" class="click">(Cliquez pour aggrandir)</a>
</div>
</div>
...
<a href="/public/images/appli-tisseo-v2/trace-de-ligne.png" class="click">(Cliquez pour aggrandir)</a>
</div>

Vous pouvez afficher la ligne pour chaque terminus en cliquant sur le bouton en haut de l'écran.

_Notez que comme l'affichage des arrêts, l'affichage des tracés de ligne est instantané car les tracés sont stoqués hors ligne sur votre mobile et synchronisés de manière transparente lorsqu'ils changent._
...
<a href="/public/images/appli-tisseo-v2/fh-pdf.png" class="click">(Cliquez pour aggrandir)</a>
</div>
...
<a href="/public/images/appli-tisseo-v2/prochainspassages-avant.png" class="click">(Cliquez pour aggrandir)</a>
</div>
<div class="thumbnail">
...
<a href="/public/images/appli-tisseo-v2/prochainspassages-apres.png" class="click">(Cliquez pour aggrandir)</a>
</div>
</div>
...
<a href="/public/images/appli-tisseo-v2/horaire-journee.png" class="click">(Cliquez pour aggrandir)</a>
</div>
...
<a href="/public/images/appli-tisseo-v2/widget.png" class="click">(Cliquez pour aggrandir)</a>
</div>
<div class="thumbnail">
...
<a href="/public/images/appli-tisseo-v2/widget-ios" class="click">(Cliquez pour aggrandir)</a>
</div>
</div>

Ce widget présente les prochains passages favoris triés par distance (si l'utilisateur accepte de donner sa position).
Afin d'économiser la baterie, ce widget ne se rafraichit qu'au clic sur les flèches.
...
Par exmple on pourrait imaginer des widget de calcul d'itinéraire ou des prochains passages à un unique arrêt plus compact.

# Autres améliorations

Globalement, une refonte estétique générale a été apportée :
* polices de caratères
* pictogrames et icônes
...
<a href="/public/images/appli-tisseo-v2/jaures-avant.png" class="click">(Cliquez pour aggrandir)</a>
</div>
<div class="thumbnail">
...
<a href="/public/images/appli-tisseo-v2/jaures-apres.png" class="click">(Cliquez pour aggrandir)</a>
</div>
</div>

Sur cet exemple, vous constaterez les nouveaux pictogrames et polices de caractère des cartouches de ligne (A, 16, NOCT, ...).
...
__5 étoiles :__
Si l'application vous plait ? Si vous voulez la voir continuer à évoluer mettez cinq étoiles sur Apple Store ou Google Play.
En plus de faire plaisir à l'équipe de développemnt, cela aide vraiment en interne à vendre le projet et à convaincre les décideurs de l'importance de ce projet et des médias d'informations voyageur en général.

Grace à une équipe interne de passionés, à l'utilisation (et la contribution) massive de l'opensource et de l'opendata la qualité des outils d'une ville comme Toulouse pour le transport public est vraiment excellente pour un investissement très réduit.
...
_Vous pouvez aussi écrire directement à digital@tisseo.fr si vous avez des remarques, des idées ou que vous voulez les enourager ;-)_
